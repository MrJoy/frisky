...
require File.expand_path(File.dirname(__FILE__)+ '/../lib/frisky/control_point/device')
    ...
    def search_and_parse(target='upnp:rootdevice')
      ...
      EM.synchrony do
        responses.each_with_index do |response, i|
          device_creator = Frisky::ControlPoint::Device.new(ssdp_notification: response)
